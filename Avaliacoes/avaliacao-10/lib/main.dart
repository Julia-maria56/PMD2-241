  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: Color(0xFF3F51B5), // Cor de fundo da AppBar
      ),
      backgroundColor: Color(0xFFE8EAF6), // Cor de fundo do Scaffold
      body: Padding(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    borderSide:
                        BorderSide(color: Color(0xFF3F51B5)), // Cor da borda
                  ),
